...
singularity exec --bind $1 $2 repair.sh in1=$BARCODE1 in2=$PATH1/1_remove_primers/R1.paired.fastq.gz out1=$PATH1/2_sync_barcodes/I1.synced.fastq.gz out2=$PATH1/2_sync_barcodes/R1.paired.fastq.gz outs=$PATH1/2_sync_barcodes/singletons.fq repair

singularity exec --bind $1 $2 repair.sh in1=$BARCODE1 in2=$PATH1/1_remove_primers/R2.paired.fastq.gz out1=$PATH1/2_sync_barcodes/I1.synced.R2.fastq.gz out2=$PATH1/2_sync_barcodes/R2.paired.fastq.gz outs=$PATH1/2_sync_barcodes/singletons.R2.fq repair
